...
from backend.database_pool import (
    pool_manager, performance_monitor, query_cache, get_dashboard_stats_optimized
)
        ...
        for test in test_queries:
            ...
            try:
                ...
                slow_queries.append({
                    ...
                    "query_text": test["query"][:100] + "..." if len(test["query"]) > 100 else test["query"]
                })
            except Exception as e:
                slow_queries.append({
                    "query_name": test["name"],
...
async def prometheus_metrics():
    ...
    try:
        from backend.performance_monitor import performance_monitor as sys_performance_monitor  # type: ignore
        ...
        return Response(content=f"# metrics unavailable: {e}\n", media_type="text/plain; version=0.0.4")
