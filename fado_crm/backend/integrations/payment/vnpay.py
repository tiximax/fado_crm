...
class VNPayGateway:
    ...
    def create_payment_url(self, order_data: Dict[str, Any], return_url: str, ipn_url: Optional[str] = None) -> Dict[str, Any]:
...
def create_vnpay_gateway(merchant_id: str = None, secret_key: str = None, is_sandbox: bool = True) -> VNPayGateway:
