...
class DatabaseOptimizer:
    ...
    def analyze_query_performance(self, db: Session):
        ...
        test_queries = [
            ...
            },
            {
                ...
                'sql': 'SELECT COUNT(*) FROM san_pham WHERE is_active = 1'
            },
            {
    ...
    def get_table_statistics(self, db: Session):
        ...
        stats = {}
        tables = ['khach_hang', 'don_hang', 'san_pham', 'chi_tiet_don_hang',
                 'lich_su_lien_he', 'nguoi_dung', 'audit_log', 'system_setting',
                 'payment_transaction']
